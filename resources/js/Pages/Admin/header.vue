        ...
        <div class="flex flex-wrap items-center">
            ...
            <div class="flex w-full pt-2 content-center justify-between md:w-1/3 md:justify-end">
                <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                    ...
                    <li class="flex-1 md:flex-none md:mr-3">
                        <Link class="inline-block text-gray-400 no-underline hover:text-gray-200 hover:text-underline py-2 px-4" :href="route('logout')" method="post" as="button">
                    ...
                    <li>
                       ...
                       <div class="text-blue-500">Create Category</div>
                         ...
                         <Link class="inline-block text-gray-400 no-underline
                         hover:text-gray-200 hover:text-underline py-2 px-4 cursor-pointer"  >
                       <div class="text-blue-500">Category</div>
                          </Link>
                    </li>
                    <li class="flex-1 md:flex-none md:mr-3">
